            ...
            style="width: 100%">
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <a :href="scope.row.icon1Url" target="_blank">
                            <img :src="scope.row.icon1Url" alt="" class="img"/>
                        </a>
                    </template>
                </el-table-column>
                <el-table-column
                    ...
                    width="300">
                    <template slot-scope="scope">
                        <a :href="scope.row.icon2Url" target="_blank">
                            <img :src="scope.row.icon2Url" alt="" class="img"/>
                        </a>
                    </template>
                </el-table-column>
                <el-table-column
                ...
                :label-width="formLabelWidth">
                        <div class="upBox">
                            <span style="margin-right:10px;">男生专区</span>
                                ...
                                >
                                    <img v-if="form.icon1Url" :src="form.icon1Url" class="avatar">
                    ...
                    <div class="upBox">
                            <span style="margin-right:10px;">女生专区</span>
                                ...
                                >
                                    <img v-if="form.icon2Url" :src="form.icon2Url" class="avatar">
                                    <i v-else class="el-icon-plus avatar-uploader-icon" />
                                </el-upload>
                        </div>
                </el-form-item>
    ...
    export default {
        ...
        methods:{
            ...
            handleAvatarSuccess(res, file) {
                this.form.icon1Url = this.$upLoadUrl + '/file/view/' + res.data
            ...
            handleAvatarSuccess1(res, file) {
                this.form.icon2Url = this.$upLoadUrl + '/file/view/' + res.data
                // this.imgUrl = URL.createObjectURL(file.raw);
                // console.log(res)
                // this.addForm.imgUrl=res.data
            },
