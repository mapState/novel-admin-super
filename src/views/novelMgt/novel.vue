            ...
            style="width: 100%">
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <a :href="scope.row.bookImage" target="_blank">
                            <img :src="scope.row.bookImage" alt="" class="img"/>
                        </a>
                    </template>
                </el-table-column>
                <el-table-column
        ...
        <el-dialog title="新增书籍" :visible.sync="dialogFormVisible" @close="diaClose">
            <el-form :model="form" ref="addForm" label-suffix=":">
                ...
                :label-width="formLabelWidth">
                    ...
                    >
                        <img v-if="form.bookImage" :src="form.bookImage" class="avatar">
    ...
    export default {
        ...
        methods:{
            ...
            handleAvatarSuccess(res, file) {
                this.form.bookImage = this.$upLoadUrl + '/file/view/' + res.data
            ...
            beforeAvatarUpload(file) {
             ...
             handleAvatarSuccess1(res, file) {
                let zipUrl = this.$upLoadUrl + '/file/view/' + res.data
