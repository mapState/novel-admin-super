            ...
            style="width: 100%">
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-button type="text" size="medium" @click="handleClick(scope.row,2)" v-if="scope.row.status==0">启用</el-button>
                        <el-button type="text" size="medium" @click="handleClick(scope.row,2)" v-else>禁用</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination
