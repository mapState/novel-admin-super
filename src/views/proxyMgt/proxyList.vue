                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <a :href="scope.row.idAImage" target="_blank">
                            <img :src="scope.row.idAImage" alt="" class="img"/>
                        </a>
                        <a :href="scope.row.idBImage" target="_blank">
                            <img :src="scope.row.idBImage" alt="" class="img"/>
                        </a>
                    </template>
                </el-table-column>
                <el-table-column
            ...
            <el-form :model="form" ref="addForm">
                ...
                :label-width="formLabelWidth">
                  <el-upload
                    ...
                    >
                        <img v-if="form.idAImage" :src="form.idAImage" class="avatar">
...
import request from '@/utils/request'
    export default {
        ...
        methods:{
            ...
            this.form.idAImage = this.$upLoadUrl + '/file/view/' + res.data
            ...
            this.form.idBImage = this.$upLoadUrl + '/file/view/' + res.data
            },
